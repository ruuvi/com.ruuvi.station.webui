const unitHelper = {
    ...
    "movementCounter": { label: "movement_counter", unit: "Times", value: (value) => value, decimals: 0 },
    "battery": { label: "battery_voltage", unit: "V", value: (value) => value / 1000, decimals: 3 },
    "accelerationX": { label: "acceleration_x", unit: "g", value: (value) => value / 1000, decimals: 3 },
    "accelerationY": { label: "acceleration_y", unit: "g", value: (value) => value / 1000, decimals: 3 },
    "accelerationZ": { label: "acceleration_z", unit: "g", value: (value) => value / 1000, decimals: 3 },
    "rssi": { label: "signal_strength", unit: "dBm", value: (value) => value, decimals: 0 },
    "txPower": { label: "tx_power", unit: "dBm", value: (value) => value, decimals: 0 },
    "mac": { label: "mac_address", unit: "", value: (value) => value, decimals: 0 },
    "dataFormat": { label: "data_format", unit: "", value: (value) => value, decimals: 0 },
    "measurementSequenceNumber": { label: "measurement_sequence_number", unit: "", value: (value) => value, decimals: 0 },
}
